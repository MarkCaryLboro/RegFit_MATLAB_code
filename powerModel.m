classdef powerModel < RegFit.covModel
    % Power Covariance Model for Heteroscedastic Data
    
    properties 
        Delta   double   = 0                                                % Power law exponent
    end
    
    properties ( Constant = true )
        CovName    RegFit.covModelType = "Power"                            % Covariance model name
